...
if __name__ == "__main__":
    ...
    logger.info(
        create_chat_completion("gpt-3.5-turbo", greeting).choices[0].message.content
    )

    logger.info(
        create_chat_completion("gpt-3.5-turbo", hannibal_question, max_tokens=100)
        .choices[0]
        .message.content
    )

    logger.info(
        create_chat_completion("gpt-3.5-turbo", storytelling, temperature=2.0)
        .choices[0]
        .message.content
    )
    ...
    logger.info(
        create_a_few_shot_chat_completion_task(
